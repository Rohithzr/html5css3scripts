(function(a){
    a.fn.my_slideshow_dot=function(p){
        var p=p||{};
        ...
        function init(){
            ...
            x.find(".thumb_box").append('<span><img src="'+d+'back_normal.png" alt="previous"  class="thumb_p"/></span>');
            x.find(".title_thumb_box").css("background-color",sf);
            for (i = 0; i <= y-1; i++)
            {
                x.find(".thumb_box").append('<span><img src="'+d+'circle_normal.png" class="thumb_num" alt="'+i+'" /></span>');
            }
            x.find(".thumb_box").append('<span><img src="'+d+'next_normal.png" alt="next"  class="thumb_n"/></span>');
            ...
            x.find(".thumb_box").children("span").children("img").hover(
                function(){
                    switch($(this).attr("class")){
                        case "thumb_p":
                            $(this).attr("src",d+"back_hoverhit.png");
                            break;
                        case "thumb_num":
                            if(parseInt($(this).attr("alt")) != w){
                                $(this).attr("src",d+"circle_hoverhit.png");
                            }
                            break;
                        case "thumb_n":
                            $(this).attr("src",d+"next_hoverhit.png");
                            break;
                    }
                },
                function(){
                    switch($(this).attr("class")){
                        case "thumb_p":
                            $(this).attr("src",d+"back_normal.png");
                            break;
                        case "thumb_num":
                            if(parseInt($(this).attr("alt")) != w){
                                $(this).attr("src",d+"circle_normal.png");
                            }
                            break;
                        case "thumb_n":
                            $(this).attr("src",d+"next_normal.png");
                            break;
                    }
                }
                );
        ...
        function play(){
            ...
            x.find(".thumb_box").children("span").children("img[class='thumb_num']").attr("src",d+"circle_normal.png");
            x.find(".thumb_box").children("span").children("img[class='thumb_num']").eq(w).attr("src",d+"circle_solid.png");
